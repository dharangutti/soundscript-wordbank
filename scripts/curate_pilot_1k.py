#!/usr/bin/env python3
"""Write corpus/v2026.07/en/pilot-1k.txt — curated 1000-lemma English pilot list."""
...
TARGET = ROOT / "corpus" / "v2026.07" / "en" / "pilot-1k.txt"

# Curated high-frequency English lemmas (CC0). One lemma per line; no proper nouns.
PILOT_1K: list[str] = [
    "a", "able", "about", "above", "accept", "across", "act", "action", "actually", "add",
    "address", "admit", "adult", "affect", "after", "again", "against", "age", "ago", "agree",
    "ahead", "air", "all", "allow", "almost", "alone", "along", "already", "also", "although",
    "always", "among", "amount", "and", "anger", "animal", "another", "answer", "any", "anyone",
    "anything", "appear", "apply", "area", "arm", "around", "arrive", "art", "article", "artist",
    "as", "ask", "at", "attack", "attention", "author", "authority", "available", "avoid", "away",
    "baby", "back", "bad", "bag", "ball", "bank", "bar", "base", "basic", "be",
    "beat", "beautiful", "because", "become", "bed", "before", "begin", "behavior", "behind", "believe",
    "bell", "belong", "below", "best", "better", "between", "beyond", "big", "bill", "bird",
    "birth", "bit", "black", "blood", "blue", "board", "body", "book", "born", "both",
    "box", "boy", "break", "bring", "brother", "build", "building", "business", "but", "buy",
    "by", "call", "camera", "campaign", "can", "cancer", "candidate", "capital", "car", "card",
    "care", "career", "carry", "case", "cat", "catch", "cause", "cell", "center", "central",
    "century", "certain", "certainly", "chair", "challenge", "chance", "change", "character", "charge", "check",
    "child", "choice", "choose", "church", "city", "civil", "claim", "class", "clear", "clearly",
    "close", "coach", "cold", "collection", "college", "color", "come", "common", "community", "company",
    "compare", "computer", "concern", "condition", "conference", "congress", "connect", "consider", "consumer", "contain",
    ...
    "plan", "plant", "play", "player", "please", "plus", "pm", "point", "police", "policy",
    ...
    "through", "throughout", "throw", "thus", "time", "to", "today", "together", "tonight", "too",
    "top", "total", "tough", "toward", "town", "trade", "traditional", "training", "travel", "treat",
    "treatment", "tree", "trial", "trip", "trouble", "true", "truth", "try", "turn", "tv",
    ...
    "wonder", "wonderful", "wood", "word", "work", "worker", "world", "worry", "would", "write",
    "writer", "wrong", "yard", "yeah", "year", "yes", "yet", "you", "young", "your",
    "yourself", "twinkle", "diamond", "shining", "hello", "singing", "melody", "harmony", "jingle", "bells",
    "photograph", "rebuild", "unhappy", "disconnect", "exchange", "enable", "above", "connect", "little", "music",
]


def main() -> int:
    lemmas = [word.strip().lower() for word in PILOT_1K if word.strip()]
    unique: list[str] = []
    seen: set[str] = set()
    for lemma in lemmas:
        if lemma in seen:
    ...
    if len(unique) < 1000:
        print(f"Expected at least 1000 unique lemmas, got {len(unique)}", file=__import__("sys").stderr)
        return 1
    ...
    TARGET.write_text("\n".join(unique) + "\n", encoding="utf-8")
    print(f"Wrote {len(unique)} lemmas to {TARGET}")
    return 0
